    ...
    <div class="w-full h-screen bg-[#080C12] text-white font-sans flex flex-col select-none overflow-hidden border border-white/10">
      ...
      <div class="flex-1 overflow-hidden p-4 flex flex-col justify-between max-w-7xl mx-auto w-full">
        ...
        <Show when={activeStage() === 'live_team'}>
          <div class="flex-1 flex flex-col justify-between h-full w-full gap-3 animate-fade-in">
            
            {/* ALLY TEAM (BLUE) TABLE */}
            <div class="flex-1 bg-[#0F1626]/95 rounded-2xl border border-val-cyan/40 px-4 py-2.5 shadow-[0_0_20px_rgba(0,229,255,0.1)] flex flex-col justify-between">
              ...
              <table class="w-full text-left font-mono text-xs my-1">
                <thead>
                ...
                <tbody class="divide-y divide-white/5">
                  <For each={allyTeam}>
                    {(player) => (
                      <tr class="hover:bg-white/5 transition-colors">
                        <td class="py-1.5 font-sans font-bold text-sm text-white flex items-center gap-2.5">
                          ...
                          <span class="truncate max-w-[180px] font-semibold">{player.name} ({player.agent})</span>
                        </td>
                        {player.isPrivate ? (
                          <td colSpan={7} class="text-center py-1.5 text-val-muted font-tactical text-xs italic tracking-wider">
                          ...
                          <>
                            ...
                            <td class="text-xs">{player.winRate}%</td>
            ...
            <div class="flex-1 bg-[#18111A]/95 rounded-2xl border border-rose-500/40 px-4 py-2.5 shadow-[0_0_20px_rgba(244,63,94,0.1)] flex flex-col justify-between">
              <div class="flex items-center justify-between pb-1.5 border-b border-white/10 shrink-0">
        ...
        <Show when={activeStage() === 'live_ffa'}>
          <div class="flex-1 bg-[#121624]/95 rounded-2xl border border-purple-500/40 px-5 py-4 shadow-[0_0_20px_rgba(147,51,234,0.1)] w-full h-full flex flex-col justify-between animate-fade-in overflow-hidden">
                  ...
                  <For each={[...allyTeam, ...enemyTeam]}>
                    {(player) => (
                      <tr class="hover:bg-white/5 transition-colors">
                        <td class="py-1.5 font-sans font-bold text-sm text-white flex items-center gap-2.5">
                          <img src={player.agentIcon} alt={player.agent} class="w-7 h-7 rounded-md bg-black border border-white/20 object-cover shadow-sm" />
                          <span class="truncate max-w-[240px] font-semibold">{player.name} ({player.agent})</span>
                        </td>
                        {player.isPrivate ? (
                          <td colSpan={7} class="text-center py-1.5 text-val-muted font-tactical text-xs italic tracking-wider">
                            🔒 PROFILE SET TO PRIVATE
