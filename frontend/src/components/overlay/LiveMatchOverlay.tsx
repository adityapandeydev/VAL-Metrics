      ...
      <div class="flex-1 overflow-hidden p-3.5 flex flex-col justify-between max-w-7xl mx-auto w-full">
        ...
        <Show when={activeStage() === 'live_team'}>
          <div class="flex flex-col justify-between h-full w-full gap-2.5 animate-fade-in">
            ...
            <div class="bg-[#0F1626]/95 rounded-2xl border border-val-cyan/40 p-3 shadow-[0_0_20px_rgba(0,229,255,0.1)] shrink-0">
              <div class="flex items-center justify-between mb-1.5 pb-1.5 border-b border-white/10">
                <h3 class="text-xs font-black font-tactical text-val-cyan uppercase tracking-wider flex items-center gap-1.5">
                  <span class="w-2 h-2 rounded-full bg-val-cyan shadow-glow-cyan" />
                  YOUR TEAM (ALLIES) • ROUND IN PROGRESS
                </h3>
                <span class="text-[11px] font-mono font-bold text-slate-300">AVG VAL-INDEX: <strong class="text-val-cyan">759</strong></span>
              </div>
              <table class="w-full text-left font-mono text-xs">
                <thead>
                  <tr class="text-val-muted uppercase text-[9px] border-b border-white/5 pb-1">
                    <th class="py-1">Agent / Name</th>
                    <th>Rank</th>
                    <th>VAL-Idx</th>
                    <th>K/D</th>
                    <th>Win%</th>
                    ...
                    {(player) => (
                      <tr class="hover:bg-white/5 transition-colors">
                        <td class="py-1 font-sans font-bold text-xs text-white flex items-center gap-2">
                          ...
                          <span class="truncate max-w-[160px]">{player.name} ({player.agent})</span>
                        </td>
                        {player.isPrivate ? (
            ...
            <div class="w-full bg-[#080B12] px-6 py-2 rounded-xl border border-white/10 flex flex-wrap items-center justify-between gap-2 shadow-lg shrink-0">
              ...
              <div class="flex items-center gap-6 font-mono text-xs">
                ...
                <div class="flex items-center gap-1.5">
                  ...
                  <span class="text-val-muted text-[10px] uppercase font-bold">AVG WIN</span>
            ...
            <div class="bg-[#18111A]/95 rounded-2xl border border-rose-500/40 p-3 shadow-[0_0_20px_rgba(244,63,94,0.1)] shrink-0">
              <div class="flex items-center justify-between mb-1.5 pb-1.5 border-b border-white/10">
                <h3 class="text-xs font-black font-tactical text-rose-400 uppercase tracking-wider flex items-center gap-1.5">
                  <span class="w-2 h-2 rounded-full bg-rose-500 shadow-glow-red" />
                  ENEMY TEAM (OPPONENTS)
                </h3>
                <span class="text-[11px] font-mono font-bold text-slate-300">AVG VAL-INDEX: <strong class="text-rose-400">773</strong></span>
              </div>
              <table class="w-full text-left font-mono text-xs">
                <thead>
                  <tr class="text-val-muted uppercase text-[9px] border-b border-white/5 pb-1">
