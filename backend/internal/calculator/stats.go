...
var AgentDirectory = map[string]struct {
	...
	"Yoru":     {"Yoru", "Duelist", "https://media.valorant-api.com/agents/7f94d257-4182-9653-e99e-71a7385a498e/displayicon.png"},
	"Neon":     {"Neon", "Duelist", "https://media.valorant-api.com/agents/bb2a4830-4604-8c91-c6ac-9cce772c8147/displayicon.png"},
	"Iso":      {"Iso", "Duelist", "https://media.valorant-api.com/agents/0e38b510-41a8-5780-5e8f-168b2a4f2d6c/displayicon.png"},
	"Waylay":   {"Waylay", "Duelist", "https://media.valorant-api.com/agents/add6443a-41bd-e414-f6ad-e58d267f4e95/displayicon.png"},

	// Initiators (7)
	"Sova":     {"Sova", "Initiator", "https://media.valorant-api.com/agents/320b2a48-4d9b-a075-30f1-1f93a9b638fa/displayicon.png"},
	"Breach":   {"Breach", "Initiator", "https://media.valorant-api.com/agents/53874278-4d6b-309b-15a4-2ca04ac4a3f4/displayicon.png"},
	"Skye":     {"Skye", "Initiator", "https://media.valorant-api.com/agents/6f2a04ca-43e0-be17-7f36-b3908627744d/displayicon.png"},
	"KAY/O":    {"KAY/O", "Initiator", "https://media.valorant-api.com/agents/601dbbe7-43ce-be57-2a40-4abd24953621/displayicon.png"},
	"Fade":     {"Fade", "Initiator", "https://media.valorant-api.com/agents/dade69b4-4f5a-8528-247b-219e5a1facd6/displayicon.png"},
	"Gekko":    {"Gekko", "Initiator", "https://media.valorant-api.com/agents/e370fa57-4757-3604-3648-499e1f642d3f/displayicon.png"},
	"Tejo":     {"Tejo", "Initiator", "https://media.valorant-api.com/agents/320b2a48-4d9b-a075-30f1-1f93a9b638fa/displayicon.png"},

	// Controllers (7)
	"Brimstone": {"Brimstone", "Controller", "https://media.valorant-api.com/agents/9f0d8ba9-42c6-92e6-4054-52864b26b219/displayicon.png"},
	...
	"Astra":     {"Astra", "Controller", "https://media.valorant-api.com/agents/443ba77e-4de8-97b5-9222-2f9eee138bc2/displayicon.png"},
	"Harbor":    {"Harbor", "Controller", "https://media.valorant-api.com/agents/95b78d7d-402a-fd4e-023f-02454369f73f/displayicon.png"},
	"Clove":     {"Clove", "Controller", "https://media.valorant-api.com/agents/7f94d257-4182-9653-e99e-71a7385a498e/displayicon.png"},
	"Miks":      {"Miks", "Controller", "https://media.valorant-api.com/agents/8e253930-4c05-31dd-1b6c-968525494517/displayicon.png"},

	// Sentinels (7)
	"Sage":     {"Sage", "Sentinel", "https://media.valorant-api.com/agents/5f8d3a7f-467b-97f3-062c-13acf203c006/displayicon.png"},
	...
	"Chamber":  {"Chamber", "Sentinel", "https://media.valorant-api.com/agents/22697a3d-45bf-8dd7-4fec-84a9e28c69d7/displayicon.png"},
	"Deadlock": {"Deadlock", "Sentinel", "https://media.valorant-api.com/agents/cc8b64c8-4b25-4ff9-6e7f-37b4da43d235/displayicon.png"},
	"Vyse":     {"Vyse", "Sentinel", "https://media.valorant-api.com/agents/6b17c243-4f90-8356-9a57-19ad0d4186cc/displayicon.png"},
	"Veto":     {"Veto", "Sentinel", "https://media.valorant-api.com/agents/117ed9e3-49f1-4350-bb9a-cb1f71a93815/displayicon.png"},
}
...
func CleanMapName(raw string) string {
	...
	if strings.EqualFold(name, "Boba") {
		...
		return "Abyss"
	} else if strings.EqualFold(name, "Corrode") || strings.EqualFold(name, "Rust") {
		return "Corrode"
	} else if strings.EqualFold(name, "Summit") || strings.EqualFold(name, "Apex") {
		return "Summit"
	}
	if len(name) == 0 {
		return "Ascent"
